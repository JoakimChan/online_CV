...
<div id="myEducations">
    ...
    <div class="education-item">
      <h3 class="school-name">Jönköping University</h3>
    ...
    <div class="education-item">
      <h3 class="school-name">Jensen Yrkeshögskola</h3>
    ...
    <div class="education-item">
      <h3 class="school-name">Tullinge Gymnasium</h3>
      <h4 class="degree-title">Natural Science Line with a Focus on Mathematics and Computer Technology</h4>
      <p class="study-period">AUG 2011 - JUN 2014</p>
      <p class="study-description">
